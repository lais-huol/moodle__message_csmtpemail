...
if ($ADMIN->fulltree) {
    if($DB->record_exists('config_plugins',array('plugin'=>'local_custonsmtp'))){
        ...
        $settings->add(new admin_setting_configselect('message_csmtpemail/mmsmtp', 'SMTP Usado','Conta de SMTP usada para enviar mensagens nesse plugin',null,$accountsArray));
    }
}
